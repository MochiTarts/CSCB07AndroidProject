...
class AdminInitializeController implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        }  catch (DatabaseInsertException | PasswordUnMatchException | SQLException | DatabaseInsertHelperException | DatabaseSelectHelperException | BuildTypeException | UserSetException e) {
            e.printStackTrace();
