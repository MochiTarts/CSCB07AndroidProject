...
public class NewAccount extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            List<Integer> i = select.getUsersByRole(findCustomerId());
            for (int id: i) {
                ...
                userId.setText(R.string.getId + " " + user.getId());
                ...
                add.setOnClickListener(new NewAccountButtonListener(this, user));

                add.setLayoutParams(buttonParam);
                add.setText(getString(R.string.createAccount));
            ...
            if (i.size() == 0) {
                ...
                message.setText(getString(R.string.noAccounts));
